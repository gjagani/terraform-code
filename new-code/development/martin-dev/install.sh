...
kubectl create configmap martin-cfg-dev -n webdev --from-file=config.yaml
kubectl create configmap nginx-cfg-dev -n webdev --from-file=nginx.conf

kubectl apply -f martin.yaml -n webdev
kubectl apply -f martin-svc.yaml -n webdev
